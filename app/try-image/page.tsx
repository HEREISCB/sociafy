  ...
  return (
    <TryPage
      ...
      steps={[
        ...
        ['Unlock and download', 'Create a free Sociafy account to remove the watermark, download the HD image, and post it straight to your socials.'],
      ]}
      faq={[
        ['Is the AI image generator really free?', 'Yes. Everyone gets free image generations every day. You can generate without an account; a free account removes the watermark and unlocks the HD download.'],
        ['Why does my image have a watermark?', 'Free previews carry a Sociafy watermark. Create a free Sociafy account and the clean, full-quality image downloads straight away and is saved to your media library.'],
